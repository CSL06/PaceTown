...
5. Use [production/characters/README.md](production/characters/README.md) for the exact-grid character sprites, atlases, and animations.
...
7. Use [production/character-redesign-v3/README.md](production/character-redesign-v3/README.md) for the improved portrait-faithful character bases. The older `production/characters/` visuals are deprecated.
