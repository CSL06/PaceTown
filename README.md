...
![Memory Charm](assets/readme/pixel_keepsake.gif)*Memory Charm: Turn an IRL photo into a tiny pixel keepsake you can carry into the game; preserve a person, place, pet, or passing moment as something small and yours. No score, no failure, no need to make it perfect; the charm is simply a way to keep a little piece of the world with you.*
